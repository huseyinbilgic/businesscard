...
public class BusinessCardServiceTest {
    ...
    void testFetchAllBusinesCardsByUsername() {
        ...
        List<BusinessCardResponse> cards = businessCardService.fetchAllBusinesCardsByUsername(user1.getUsername());

        assertEquals(2, cards.size());

        Optional<BusinessCardResponse> card1 = cards.stream().filter((bc) -> bc.getId() == businessCard1.getId())
                .findFirst();
        ...
        Optional<BusinessCardResponse> card2 = cards.stream().filter((bc) -> bc.getId() == businessCard2.getId())
                .findFirst();
